...
namespace ThyniusWeb.Server.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(ApplicationDbContext context, UserManager<ApplicationUser> userManager, IAmazonS3 amazonS3, IConfiguration configuration)
        {
            _context = context;
        ...
        {
            return await _context.Users.Where(s => s.Email == email).FirstOrDefaultAsync();
        }
