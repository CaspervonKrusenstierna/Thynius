    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Organizations", x => x.EmailExtension);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrganizationEmailExtension = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Organizations_OrganizationEmailExtension",
                        column: x => x.OrganizationEmailExtension,
                        principalTable: "Organizations",
                        principalColumn: "EmailExtension",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_OrganizationEmailExtension",
                table: "AspNetUsers",
                column: "OrganizationEmailExtension");
