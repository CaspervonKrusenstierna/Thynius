    ...
    <div className="flex-column">
        ...
        <div className='flex flex-col justify-self-center mt-[70px] ml-[20%] w-[60%] pb-[200px]'>
            ...
            <div className='flex flex-row pt-[11px]'>
                <p className='text-[25px]'> &bull; </p>
                <p className='ml-3 mt-[9px]'>
                    <span className='text-[18px]'> Rättigheten att korrigera din information. Du be oss ändra eller korrigera din information om den inte är korrekt.</span>
                </p>
            </div>
            ...
            <p className='text-[18px] mt-6'>Om du vill utöva någon av ovanstående rättigheter kan du kontakta oss kostnadsfritt via kontaktsformuläret som du finner längst ned på denna sida.</p>
